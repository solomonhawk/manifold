...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    <AlertDialogOverlay className="flex flex-col items-center justify-around overflow-auto p-16 md:py-44">
...
const AlertDialogHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-8 sm:text-left", className)}
    {...props}
  />
);
